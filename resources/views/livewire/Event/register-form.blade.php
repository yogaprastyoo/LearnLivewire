<div class="shadow h-fit rounded-lg w-full p-4 space-y-4 bg-white">
    ...
    <form wire:submit='createNewUser'>
        ...
        {{-- ImageInput --}}
        <div>
            <label for="upload-{{ $iterationImage }}" class="block text-sm mt-3 font-medium text-gray-700">
                Image
            </label>
            ...
            {{-- UploadStatus --}}
            <p wire:loading.delay.longest wire:target='image' class="mt-1 text-xs text-green-600">
                Uploading Image...
            </p>
        </div>
